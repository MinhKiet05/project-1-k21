        ...
        <div className="footer-container">
          ...
          <div className="footer-contact">
            ...
            <ul>
              <li>
                <b>{t("footer.email")}:</b>{" "}
                <a href="mailto:notungphoco@gmail.com">notungphoco@gmail.com</a>
              </li>
              <li>
                <b>{t("footer.phone")}:</b>{" "}
                <a href="tel:0336748385">0336748385</a>
              </li>
              <li>
                <b>{t("footer.address")}:</b> {t("footer.address_value")}
              </li>
            </ul>
          </div>
        </div>
